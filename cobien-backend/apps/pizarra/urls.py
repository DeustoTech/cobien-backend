...
urlpatterns = [
    ...
    path('api/user-assignments/', views.api_user_assignments, name='pizarra_api_user_assignments'),
    ...
    path('api/messages/bulk-set-expiry/', views.api_bulk_set_message_expiry, name='pizarra_api_bulk_set_expiry'),
    path('api/messages/<str:post_id>/read/', views.api_mark_message_read, name='pizarra_api_mark_message_read'),
    path('api/messages/<str:post_id>/reply/', views.api_submit_quick_reply, name='pizarra_api_submit_quick_reply'),
    ...
    path('api/device/logs/content/', views.api_device_log_content, name='pizarra_api_device_log_content'),
